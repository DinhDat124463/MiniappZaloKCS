...
declare const AuthenScopeProperty: ZodEnum<["scope.userInfo", "scope.userLocation", "scope.userPhonenumber"]>;
type AuthenScopeType = TypeOf<typeof AuthenScopeProperty>;
type AuthenResponse = Partial<{
    [key in AuthenScopeType]: boolean;
}>;
