...
.zaui-avatar-online {
  ...
  bottom: calc(calc(48px * 0.1464) - calc(10px * 0.75));
  right: calc(calc(48px * 0.1464) - calc(10px * 0.75));
}
.zaui-avatar-image {
  width: 100%;
  height: 100%;
...
.zaui-avatar-blocked {
  ...
  position: absolute;
  box-sizing: content-box;
  bottom: calc(calc(48px * 0.1464) - calc(12px * 0.75));
  right: calc(calc(48px * 0.1464) - calc(12px * 0.75));
}
...
.zaui-avatar-story-seen .zaui-avatar-inner {
  width: calc(48px - calc(2px * 4));
  height: calc(48px - calc(2px * 4));
  left: calc(2px * 2);
  top: calc(2px * 2);
}
...
.zaui-avatar-story-seen::before {
  ...
  border-radius: 100%;
  z-index: -1;
  width: calc(48px - calc(2px * 2));
  height: calc(48px - calc(2px * 2));
...
.zaui-avatar-group .zaui-avatar-group-item .zaui-avatar-inner {
  border: solid var(2px) var(--zaui-light-avatar-border, #ffffff);
}
...
body[zaui-theme="dark"] .zaui-avatar-group .zaui-avatar-group-item .zaui-avatar-inner {
  border: solid var(2px) var(--zaui-dark-avatar-border, #141415);
}
.zaui-modal-content {
